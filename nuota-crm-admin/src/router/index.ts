...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/finance', component: () => import('../views/finance/FinanceOverview.vue'), meta: { title: '财务总览' } },
  { path: '/finance/income', component: () => import('../views/finance/IncomeDetail.vue'), meta: { title: '收费明细' } },
  { path: '/finance/fixed-costs', component: () => import('../views/finance/FixedCosts.vue'), meta: { title: '固定成本' } },
  { path: '/finance/breakeven', component: () => import('../views/finance/Breakeven.vue'), meta: { title: '盈亏平衡核算' } },
  { path: '/finance/statement', component: () => import('../views/finance/MonthlyStatement.vue'), meta: { title: '月度核算表' } },
